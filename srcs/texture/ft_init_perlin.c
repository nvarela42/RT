...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/29 15:27:16 by vmontagn          #+#    #+#             */
/*   Updated: 2018/05/14 12:25:19 by nvarela          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

static void		init_perlin_permutation(int *perlin)
{
	int			i;
	static int	permutation[] = {151, 160, 137, 91, 90, 15,
		...
		16, 58, 17, 182, 189, 28, 42, 223, 183, 170, 213, 119, 248, 152, 2, 180,
...
int				*ft_init_perlin(void)
{
	...
	if ((perlin = (int *)malloc(sizeof(int) * 512)) == NULL)
		ft_perror(NULL, TRUE);
	init_perlin_permutation(perlin);
	return (perlin);
}

void			ft_free_perlin(t_scene *scn)
{
	free(scn->perlin_permutation);
	scn->perlin_permutation = NULL;
}
